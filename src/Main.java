...
public class Main {
    ...
    private static void Constrain2() {
        ...
        // add booking
        Booking b1 = new Booking(Model.getDateFromString("26-12-2019"),r1);
        Booking b2 = new Booking(Model.getDateFromString("27-12-2019"),r2);
        Booking b3 = new Booking(Model.getDateFromString("29-12-2019"),r3);
        Booking b4 = new Booking(Model.getDateFromString("25-11-2019"),r4);
        ...
        m1.addObjectToModel(res3);
        m1.addObjectToModel(res4);
        m1.addObjectToModel(b1); // link booking to model
        m1.addObjectToModel(b2); // link booking to model
        m1.addObjectToModel(b3); // link booking to model
        m1.addObjectToModel(b4); // link booking to model

        // link booking to room
        m1.create_link_room_Booking(r1,b1);
        m1.create_link_room_Booking(r2,b2);
        m1.create_link_room_Booking(r3,b3);
        m1.create_link_room_Booking(r4,b4);
        m1.create_link_reservation_booking(b1,res1);
        m1.create_link_reservation_booking(b2,res2);
        m1.create_link_reservation_booking(b3,res3);
        m1.create_link_reservation_booking(b4,res4);
        ...
        m1.create_link_room_roomCategory(r1, roomCategory);
        m1.create_link_room_roomCategory(r2, roomCategory);
        m1.create_link_room_roomCategory(r3, roomCategory);
        m1.create_link_room_roomCategory(r4, roomCategory);
        m1.create_link_room_roomCategory(r5, roomCategory);

        System.out.println("Constraint 2: need True: " + m1.checkModelConstraints());
        Booking b5 = new Booking(Model.getDateFromString("21-12-2019"),r5);
        m1.addObjectToModel(b5); // link booking to model
        m1.create_link_room_Booking(r5,b5);

        Reservation res5 = new Reservation(Model.getDateFromString("21-12-2019"), Model.getDateFromString("25-12-2019"), 104);
        m1.addObjectToModel(res5);
        m1.create_link_reservation_booking(b5,res5);
        m1.create_link_reservationSet_reservation(reservationSet, res5);
        m1.create_link_reservation_roomCategory(res5, roomCategory);
